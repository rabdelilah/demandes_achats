		...
		<div class="wrap">
            ...
            <div id="content">
                ...
                <div id="main">
                    ...
                    <!--               main             -->
                    <h3>Validation Damande D'achat</h3>
                    ...
                    <table>
                    	...
                    	<tr>
                    		<td colspan="3">
                    			...
                    			<input type="hidden" name="op" value="validation_da" />
                    ...
                    <table width='100%' cellpadding='0' cellspacing='0' border='0' class='tablesorter hasFilters'> 
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2">
									<input type="hidden" name="op" value="add_ligne_validation"/>
									<input type="hidden" name="id_doc" value="<%=request.getParameter("id")%>"/>
							...
							<tr>
								...
								<td colspan="2">
									<input type="hidden" name="op" value="edit_ligne_validation"/>
									<input type="hidden" name="id_doc" value="<%=request.getParameter("id")%>"/>
							...
							<tr>
								...
								<%} %>
								<td><a href="validation_da.jsp?mode=editDoc&mode2=editLigne&id=<%=request.getParameter("id") %>&id_ligne=<%=donnee.get(i)[0] %>"><img src="img/i_edit.png"/></a></td>
								<td><a href="action?op=delete_ligne_validation&id_doc=<%=request.getParameter("id") %>&id_ligne=<%=donnee.get(i)[0] %>"><img src="img/i_delete.png"/></a></td>
							</tr>
							<%} %>
						</tbody>
					</table>
